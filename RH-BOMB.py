...
def update():
    ...
    try:
        parsedData = requests.get("https://raw.githubusercontent.com/Toxic-Noob/RH-BOMBER/main/more/.version").json()
    except:
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && rm -rf RH-BOMBER && git clone https://github.com/Toxic-Noob/RH-BOMBER > /dev/null 2>&1")
        
        print("\033[37mDone")
        psb("\n    \033[92m[\033[37m*\033[92m] \033[37mStarting Tool...")
        time.sleep(0.8)
        
        os.system("cd .. && cd RH-BOMBER && python Tbomb.py")
